import { math, Vec2 } from "../core";
import { EventMouse } from "../input/Events";
import { ProgressTitleType } from "./common/FieldTypes";
...
export class GSlider extends GComponent {
    ...
    private onGripTouchBegin(evt: EventMouse): void {
        this.canDrag = true;
        evt.stopPropagation();

        this._clickPos = this.globalToLocal(evt.worldX, evt.worldY);
    ...
    private onGripTouchMove(evt: EventMouse): void {
        ...
        var pt: Vec2 = this.globalToLocal(evt.worldX, evt.worldY, Vec2.temp1Vec2);
    ...
    private onBarTouchBegin(evt: EventMouse): void {
        ...
        var pt: Vec2 = this._gripObject.globalToLocal(evt.worldX, evt.worldY, Vec2.temp1Vec2);
