import { serializable, SQBoolean, sqclass, SQFloat, type } from "../../../core/index";
import { Joint2DComponent } from "./Joint2DComponent";
import { ComponentType } from "../../../native_binding/index";

@sqclass("sq.PrismaticJoint2DComponent")
export default class PrismaticJoint2DComponent extends Joint2DComponent {
    ...
    private _enableSyncAngle?: boolean;
    constructor() {
        super();
        this.nativeType = ComponentType.PrismaticJoint2DComponent;
    }
    ...
    set enableSyncAngle(enable: boolean) {
        if (this._enableSyncAngle !== enable) {
            this._enableSyncAngle = enable;
